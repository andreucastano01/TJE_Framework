...
const char buttons_old[] = { A_BUTTON, B_BUTTON, X_BUTTON, Y_BUTTON, LF_BUTTON, RF_BUTTON, BACK_BUTTON, START_BUTTON, LEFT_ANALOG_BUTTON, RIGHT_ANALOG_BUTTON };
const char buttons_15[] = { PAD_LEFT, PAD_UP, PAD_RIGHT, PAD_DOWN, START_BUTTON, BACK_BUTTON, LEFT_ANALOG_BUTTON, RIGHT_ANALOG_BUTTON, LF_BUTTON, RF_BUTTON, A_BUTTON, B_BUTTON, X_BUTTON, Y_BUTTON, -1, -1, -1, -1 };
